...
@section('body')
    ...
    <div class="row">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Forum </span> Resource
            ...
            <div class="mt-3">
                ...
                <div class="modal fade" id="basicModal" tabindex="-1" style="display: none;" aria-hidden="true">
                    <form action="{{route('create_forum')}}" method="post" enctype="multipart/form-data" class="modal-dialog" role="document">
                        @csrf
                    ...
                    <table id="table" class="dt-multilingual table border-top">
                        ...
                        @foreach($list as $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('delete_forum', $data->id)}}" class="btn btn-outline-danger mb-2">Delete</a>
